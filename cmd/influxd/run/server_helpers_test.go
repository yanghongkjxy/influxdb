...
func NewConfig() *run.Config {
	...
	c.Meta.HeartbeatTimeout = toml.Duration(1000 * time.Millisecond)
	c.Meta.ElectionTimeout = toml.Duration(1000 * time.Millisecond)
	c.Meta.LeaderLeaseTimeout = toml.Duration(1000 * time.Millisecond)
